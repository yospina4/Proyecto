			...
			<div class="row clearfix">
				...
				<div class="col-md-6 alert alert-secondary">
					...
					<form action="datos.php" method="post">
					  ...
					  <div class="form-group">
					    <label for="">Actualmente estas recibiendo algún tratamiento psicologico</label>
					  ...
					  <div class="form-group">
					    ...
					    <textarea class="form-control" name="descripcion" id="descripcion" placeholder="Ingresa tu descripción"></textarea>
					  </div>	
					  <br>
